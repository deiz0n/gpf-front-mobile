import {
  ...
  export default function EditCardiorespiratoryEvaluation() {
    const fontsLoaded = customFonts();
    const router = useRouter();
    const { recordId } = useLocalSearchParams<{ recordId: string }>();
    const { loading, error, handleUpdate, handleGetById } = useCardio();
            ...
            if (response && response.record) {
              ...
              setFormData(prev => ({
                ...
                physicalInspection: {
                  ...
                  nasalSecretion: {
                    ...prev.physicalInspection.nasalSecretion,
                ...
                pneumofunctionalAssessment: {
                  ...prev.pneumofunctionalAssessment,
                  ...(record.pneumofunctionalAssessment || {}),
                  peakFlow: {
                    ...prev.pneumofunctionalAssessment.peakFlow,
                    ...(record.pneumofunctionalAssessment?.peakFlow || {})
                  },
                  manovacuometry: {
                    ...prev.pneumofunctionalAssessment.manovacuometry,
                    ...(record.pneumofunctionalAssessment?.manovacuometry || {}),
                    pemax: {
                      ...prev.pneumofunctionalAssessment.manovacuometry.pemax,
                      ...(record.pneumofunctionalAssessment?.manovacuometry?.pemax || {})
                    },
                    pimax: {
                      ...prev.pneumofunctionalAssessment.manovacuometry.pimax,
                ...
                cardiofunctionalAssessment: {
                  ...prev.cardiofunctionalAssessment,
                  ...(record.cardiofunctionalAssessment || {}),
                  bioimpedance: {
                    ...prev.cardiofunctionalAssessment.bioimpedance,
                    ...(record.cardiofunctionalAssessment?.bioimpedance || {})
                  },
                  adipometry: {
                    ...prev.cardiofunctionalAssessment.adipometry,
                    ...(record.cardiofunctionalAssessment?.adipometry || {}),
                    skinfoldMeasurements: {
                      ...prev.cardiofunctionalAssessment.adipometry.skinfoldMeasurements,
